...
public class DataInitializerServiceImpl implements DataIntializerServiceContract {
    ...
    private void createPermissions(){
        List<String> permissions = List.of(
                ...
                Permissions.PURCHASE_APPROVE_SHORT,
    ...
    private void createCashierRole() {
        Set<Permission> permissions = new HashSet<>(Set.of(
                ...
                permissionRepository.findByName(Permissions.PURCHASE_VIEW).orElseThrow(),
                permissionRepository.findByName(Permissions.PURCHASE_RECEIVE).orElseThrow(),
